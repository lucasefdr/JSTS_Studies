...
function topSalary(salaries) {
  const orderedSalaries = Object.entries(salaries) // Transforma o objeto em um array de [chave, valor]
    .sort((a, b) => b[1] - a[1]); // Ordena o array com base nos valores (salários) em ordem decrescente

  return orderedSalaries[0][0]; // Retorna a chave (nome) do primeiro elemento do array ordenado
}

console.log(topSalary(companySalaries));
